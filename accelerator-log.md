...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=garethjevans&repo=monorepo-supply-chain",
  "buildTool" : "kpack",
  ...
  "hasSourceScan" : false,
  "hasTests" : true,
  "projectName" : "monorepo-supply-chain",
  "workloadType" : "monorepo"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [configWriterTemplate->config-writer-and-pu...(truncated), buildTool->kpack-template, source-test-scan-to-url->monorepo-supply-chai...(truncated), externalDeliveryTemplate->deliverable-template, workloadType->monorepo]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=garethjevans&repo=monorepo-supply-chain'
